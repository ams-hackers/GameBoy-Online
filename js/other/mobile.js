...
function pickRandomColor() {
  ...
  $("gameboy_shell").style.backgroundColor = $(
    "on_off"
  ).style.color = nintendo.style.borderColor = nintendo.style.color =
...
function registerGUIEvents() {
  ...
  addEvent(
    "click",
    document.getElementById("GameBoy_settings_menu"),
    function () {
      windowStacks[3].show();
    }
  );
  ...
  new popupMenu(
    document.getElementById("GameBoy_file_menu"),
    document.getElementById("GameBoy_file_popup")
  );
  ...
  new popupMenu(
    document.getElementById("GameBoy_view_menu"),
    document.getElementById("GameBoy_view_popup")
  );
